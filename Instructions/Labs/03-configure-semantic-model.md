...
1. Nella casella Nome del**riquadro**Proprietà** sostituire il valore con_Products_.**
...
1. Nel riquadro**Proprietà**, nella casella**Cartella di visualizzazione**, immettere_Formatting_.
...
1. `Region` Nella tabella creare una gerarchia denominata_Regions_ con i tre livelli seguenti:
...
1. `Reseller` Nella tabella creare una gerarchia denominata_Resellers_ con i due livelli seguenti:

     - `Business Type`
     - `Reseller`

1. Creare una seconda gerarchia denominata_Geography_ con i quattro livelli seguenti:
...
1. **Nel riquadro Proprietà** impostare la**proprietà Thousands Separator su_Sì_ all'interno della**sezione Formattazione****.

1. Selezionare la`Unit Price` colonna .

1. Nel riquadro**Proprietà**, nella sezione**Formattazione**, impostare la proprietà**Posizioni decimali** su_2_.
...
1. **Nel riquadro Proprietà** impostare la**proprietà Is Hidden** su_Sì_.
...
1. Nel riquadro**Proprietà**, nella sezione**Formattazione**, impostare l'interruttore per la proprietà**Posizioni decimali** su_0_ (zero).
...
1. `Sales` Nella tabella aggiungere una seconda misura rapida in base ai requisiti seguenti:
    ...
    - Rinominare la misura come_Profit Margin_.
...
1. Si noti che_Michael Blythe_ ha generato quasi 9 milioni di dollari di vendite.
...
1. Nella finestra**Modifica relazione**, nell'elenco a discesa**Direzione filtro incrociato** selezionare_Entrambe_.
...
1. Nella casella Nome del**riquadro**Proprietà** sostituire il testo con_Salesperson (Prestazioni)._**
