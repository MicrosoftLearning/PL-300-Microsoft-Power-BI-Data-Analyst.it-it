...
Estrarre la cartella nella **cartella C:\Users\Student\Downloads\02-load-data** .
...
1. **Nella casella Formula** colonna personalizzata immettere l'espressione seguente (dopo il simbolo di uguale), quindi salvare la nuova colonna:
   ...
   ` if [TotalProductCost] = null then [OrderQuantity] * [StandardCost] else [TotalProductCost] `
    ...
    > ***Nota**: è possibile copiare l'espressione dal **file Snippets.txt** nella cartella 02-load-data.*
