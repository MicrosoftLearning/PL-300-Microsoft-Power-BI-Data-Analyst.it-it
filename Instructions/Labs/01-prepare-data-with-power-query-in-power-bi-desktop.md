...
Estrarre la cartella nella **cartella C:\Users\Student\Downloads\01-prepare-data** .
...
1. Passare al **file 01-prepare-data > ResellerSalesTargets.csv** . Selezionare **Apri**.
...
1. Controllare le icone in ogni intestazione di colonna, a sinistra del nome della colonna. Le icone rappresentano il tipo di dati della colonna. **123** indica un numero intero e **ABC** indica il testo.
     ...
     ![Tipo di dati colonna](Linked_image_Files/01-prepare-data-with-power-query-in-power-bi-desktop_image38.png)
