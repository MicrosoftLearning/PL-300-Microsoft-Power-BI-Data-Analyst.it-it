...
1. **Nella casella Cerca** immettere_Layout_.

1. Impostare la**proprietà Layout** su_Tabulare_.
...
1. Nella**visualizzazione** Modello inserire le tre nuove misure in una cartella di visualizzazione denominata_Ratios_.
