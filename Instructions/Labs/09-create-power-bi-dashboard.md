...
1. Selezionare il **file 09-Starter-Sales Analysis.pbix** e quindi selezionare **Apri**.
...
1. **Nella casella URL** del **riquadro Aggiungi riquadro** immagine immettere l'URL completo disponibile nel **file C:\Users\Student\Downloads\09-create-dashboard\AdventureWorksLogo_DataURL.txt** e quindi **Applica**.
