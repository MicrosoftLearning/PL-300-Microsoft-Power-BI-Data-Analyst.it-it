...
In questa attività si creerà una connessione dinamica al set di dati di Power BI creato nell'ultima attività e quindi si creerà un nuovo **report di esplorazione** delle vendite.
...
1. **Nella finestra Hub** dati selezionare il **set di dati Sales Analysis** in **Area di lavoro** personale e quindi **Connessione** o fare doppio clic per caricare il set di dati.
